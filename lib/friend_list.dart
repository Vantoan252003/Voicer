...
class FriendListWidget extends StatelessWidget {
  ...
  FriendListWidget({super.key, required this.userId, required this.firestore}) {
            ...
            onPressed:
                () => Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            FriendRequest(userId: userId, firestore: firestore),
                  ),
                ),
          ),
        ],
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              var doc = docs[index];
              String friendId =
                  doc['user1'] == userId ? doc['user2'] : doc['user1'];
